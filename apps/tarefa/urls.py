...
urlpatterns = [
    ...
    path('filtrar-por-projeto-e-por-membro/', FiltrarTarefasPorMembroEPorProjetoView.as_view(), name='filtrar_por_projeto_e_por_membro'),
    path('excluir/', ExcluirTarefaView.as_view(), name="excluir_tarefas"),
