...
urlpatterns = [
    ...
    path('excluir-individual/', ExcluirMembroProjetoOneView.as_view(), name='excluir_membro_projeto_individual'),
    path('excluir-multiplo/', ExcluirMembroProjetoManyView.as_view(), name='excluir_membro_projeto_multiplo'),
