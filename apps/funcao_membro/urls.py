...
urlpatterns = [
    ...
    path('listar-funcoes-do-membro/', ListarFuncaoMembroProjetoPeloIDView.as_view(), name='listar_funcoes_do_membro_pelo_id_membro'),
    path('listar-funcoes-dos-membros-do-projeto/', ListarFuncaoMembroProjetoPorProjetoView.as_view(), name='listar_funcoes_dos_membros_pelo_id_projeto'),
