...
import VisualizarArtefato from "./pages/Artefato/screens/VisualizarArtefato/VisualizarArtefato";
  ...
  return (
    <Switch>
      ...
      <Route element={<AdminRoutes />}>
        ...
        <Route path="/admin/artefatos/visualizar-artefato/" Component={VisualizarArtefato} exact/>
