...
//             }
//         } catch (error) {
//             handleError(new Error(`Erro ao obter tarefas: ${error.message}`));
//         }
//     };
...
//             }
//         } catch (error) {
//             handleError(new Error(`Erro ao obter artefatos: ${error.message}`));
//         }
//     };
...
//         } catch (error) {
//             handleError(new Error(`Erro ao obter commits: ${error.message}`));
//         }
//     };
